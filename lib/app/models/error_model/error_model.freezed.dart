...
mixin _$ErrorModel {
  ...
  bool get isUrgentError => throw _privateConstructorUsedError;
...
abstract class $ErrorModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? code, String? message, bool isUrgentError});
}
    ...
    return _then(_value.copyWith(
      ...
      message: freezed == message
          ...
          : message // ignore: cast_nullable_to_non_nullable
              as String?,
      isUrgentError: null == isUrgentError
          ? _value.isUrgentError
          : isUrgentError // ignore: cast_nullable_to_non_nullable
              as bool,
    ) as $Val);
  }
}
...
class _$ErrorModelImpl implements _ErrorModel {
  const _$ErrorModelImpl(
      {required this.code, required this.message, this.isUrgentError = false});
  ...
  @override
  @JsonKey()
  final bool isUrgentError;

  @override
  String toString() {
    return 'ErrorModel(code: $code, message: $message, isUrgentError: $isUrgentError)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isUrgentError, isUrgentError) ||
                other.isUrgentError == isUrgentError));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, code, message, isUrgentError);
...
abstract class _ErrorModel implements ErrorModel {
  const factory _ErrorModel(
      ...
      final bool isUrgentError}) = _$ErrorModelImpl;
